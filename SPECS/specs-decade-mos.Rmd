...
fw1name <- paste('specsdecadal.z.fw.y1.gcm',iexp,'rda',sep='.')
mu1name <- paste('specsdecadal.z.mu.y1.gcm',iexp,'rda',sep='.')
fw3name <- paste('specsdecadal.z.fw.y1.3.gcm',iexp,'rda',sep='.')
mu3name <- paste('specsdecadal.z.mu.y1.3.gcm',iexp,'rda',sep='.')
fw5name <- paste('specsdecadal.z.fw.y1.5.gcm',iexp,'rda',sep='.')
mu5name <- paste('specsdecadal.z.mu.y1.5.gcm',iexp,'rda',sep='.')
fw9name <- paste('specsdecadal.z.fw.y1.9.gcm',iexp,'rda',sep='.')
mu9name <- paste('specsdecadal.z.mu.y1.9.gcm',iexp,'rda',sep='.')
