...
library(esd)
setwd('/lustre/storeA/users/rasmusb')
...
plot(subset(z,is='Arusha'),target.show=FALSE,map.show=FALSE,legend=FALSE,xlim=c(1900,2100))
figlab('MAM')
dev.copy2pdf(file=paste('figure4g.',param,'.pdf',sep=''))

plot(subset(z,is='Musoma'),target.show=FALSE,map.show=FALSE,legend=FALSE,xlim=c(1900,2100))
figlab('MAM')
dev.copy2pdf(file=paste('figure4h.',param,'.pdf',sep=''))
