...
```{r winter-rain, warning=FALSE, message=FALSE}
...
```{r sl-trend-map, warning=FALSE, message=FALSE}
zc <- coredata(Z)
...
```{r trend-event-2006, warning=FALSE, message=FALSE}
plot(annual(uv,nmin=300),main='zonal and meridional wind components',
     xlim=c(2000,2010))
```
...
```{r zonal-wind-check1, warning=FALSE, message=FALSE}
## Trend in upper wind direction
...
```{r zonal-wind-check2, warning=FALSE, message=FALSE}
## Trend in upper wind direction
...
```{r wind-speed-trend-2, warning=FALSE, message=FALSE}
## Trend in upper wind speed
...
```{r EOFs-in-precip-mu, warning=FALSE, message=FALSE}
## The area mean wet-day mean precipitation
eof.mu <- EOF(mu)
## The area mean wet-day frequency
plot(eof.mu)
...
```{r EOFs-in-precip-fw, warning=FALSE, message=FALSE}
## Show maps of trends for the wet-day mean precipitation
eof.fw <- EOF(fw)
## Map of trends in wet-day frequency:
plot(eof.fw)
...
```{r residual-for-mu, warning=FALSE, message=FALSE}
...
```{r EOF-for-mu, warning=FALSE, message=FALSE}
## The residual of the wet-day precipitation
plot(EOF(mu))
```


```{r residual-for-fw, warning=FALSE, message=FALSE}
...
For comparison the original data look like this:
```{r EOF-for-fw, warning=FALSE, message=FALSE}
## The residual of the wet-day precipitation
plot(EOF(fw))
```
