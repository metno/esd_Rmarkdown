...
```{r DS, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
## The wet-day frequency and SLP
...
zc -> coredata(Z)
map(Z,pch=19,FUN='trend',cex=-2,add.text=TRUE)
```
...
plot(annual(uv,nmin=300),main='zonal and meridional wind components',
     xlim=c(2000,2010),map.show=FALSE)
grid()
```
...
```{r zonal-wind-check2, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
## Trend in upper wind direction
