...
Take hot events to be any day warmer than 30C:

```{r}
nhot <- annual(climatrans.tx,FUN='count',threshold=35)
plot(nhot,new=FALSE)
...
```{r}
  ...
  for (i in 1:3) {
    ...
    hw <- hotsummerdays(x=y,dse=dse.tx,threshold=trh[i],plot=TRUE,new=FALSE)
    #plot(hw)
  }
```
