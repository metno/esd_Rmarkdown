...
Model the number with heavy rainfall (more than 50 mm/day) in Delhi and Bangalore.
...
plot(1949:2004,ndhr50.1.cal$y,pch=19,ylab=expression(N(X > 100*mm)),xlab='',main=loc(ndhr50)[1])
grid()
...
plot(1949:2004,ndhr50.3.cal$y,pch=19,ylab=expression(N(X > 100*mm)),xlab='',main=loc(ndhr50)[3])
grid()
...
```{r}
print(paste('Mean number=',mean(ndhr100[,2],na.rm=TRUE),'Variance=',var(ndhr100[,2],na.rm=TRUE),
            'should equal',mean(ndhr100[,2],na.rm=TRUE),'for Poisson process'))
